...
Public Class StaffMainForm
    ...
    Private Sub StaffMainForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            AttendanceStatusBox.SelectedIndex = 0
    ...
    Public Sub displayAttendance()
        ...
        cmd.CommandText = "select * from Attendances where StaffId='" + staffNameTxt.Text + "'"
        cmd.ExecuteNonQuery()
    ...
    Public Sub displaySales()
        ...
        cmd = con.CreateCommand()
        cmd.CommandType = CommandType.Text
        cmd.CommandText = "select * from Sales where StaffId='" + staffNameTxt.Text + "'"
        cmd.ExecuteNonQuery()
    ...
    'Attendance Page'
    Private Sub btnAttendanceAdd_Click(sender As Object, e As EventArgs) Handles btnAttendanceAdd.Click
        Try
            If con.State = ConnectionState.Open Then
                con.Close()
            End If
            ...
            Dim dateDetail As String = DateTime.Now
            Dim time As String = DateTime.Now.ToShortTimeString()
            Dim timeDetail As String = DateTime.Parse(time).ToString("HH:mm:ss")
            Dim validate As String = "select * from Attendances where StaffId='" + staffNameTxt.Text + "' and Date='" + dateDetail + "' and Status='" + AttendanceStatusBox.Text + "'"
            ...
            If dt.Rows.Count > 0 Then
                If AttendanceStatusBox.Text = "Check In" Then
                    MessageBox.Show("You have already check in for today!", "Information", MessageBoxButtons.OK, MessageBoxIcon.Hand)
                Else
                    MessageBox.Show("You have already check out for today!", "Information", MessageBoxButtons.OK, MessageBoxIcon.Hand)
                End If
            Else
                Dim addQuery = "insert into Attendances values('" + timeDetail + "', '" + AttendanceStatusBox.Text + "', '" + dateDetail + "', '" + staffNameTxt.Text + "')"
                ...
                Select Case x
                    Case 1
                        MessageBox.Show("Check Successfully!!", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        displayAttendance()
                    Case 0
                        MessageBox.Show("Wrong entry!!!", "Errors", MessageBoxButtons.OK, MessageBoxIcon.Error)
                End Select
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message)
    ...
    Private Sub btnAttendanceSearch_Click(sender As Object, e As EventArgs) Handles btnAttendanceSearch.Click
        Try
            ...
            cmd = con.CreateCommand()
            cmd.CommandType = CommandType.Text
            cmd.CommandText = "select * from Attendances where Date >='" + AttendanceFilterStart.Value + "' and Date <='" + AttendanceFilterEnd.Value + "' and StaffId ='" + staffNameTxt.Text + "'"
            cmd.ExecuteNonQuery()
    ...
    Private Sub btnAttendanceRefresh_Click(sender As Object, e As EventArgs) Handles btnAttendanceRefresh.Click
        Try
            ...
            AttendanceFilterStart.Value = DateTime.Now
            AttendanceFilterEnd.Value = DateTime.Now
    ...
    Private Sub btnSalesSearch_Click(sender As Object, e As EventArgs) Handles btnSalesSearch.Click
        Try
            ...
            cmd = con.CreateCommand()
            cmd.CommandType = CommandType.Text
            cmd.CommandText = "select * from Sales where SalesDate >='" & DateStartSales.Value & "' and SalesDate <='" & DateEndSales.Value & "' and StaffId ='" & staffNameTxt.Text & "'"
            cmd.ExecuteNonQuery()
    ...
    Private Sub btnAddSales_Click(sender As Object, e As EventArgs) Handles btnAddSales.Click
        Try
            ...
            cmd = con.CreateCommand()
            cmd.CommandType = CommandType.Text
            cmd.CommandText = "insert into Sales values('" + SalesDatePicker.Value + "', '" + staffNameTxt.Text + "', '" + SalesQuantityTxt.Text + "', '" + SalesCustNameTxt.Text + "', '" + SalesCustConTxt.Text + "', '" + SalesPriceTxt.Text + "', '" + SalesProductNameTxt.Text + "')"
    ...
    Private Sub btnSalesSave_Click(sender As Object, e As EventArgs) Handles btnSalesSave.Click
        Try
            ...
            cmd = con.CreateCommand()
            cmd.CommandType = CommandType.Text
            cmd.CommandText = "update Sales Set SalesDate='" + SalesDatePicker.Value + "', StaffId='" + staffNameTxt.Text + "', Quantity='" + SalesQuantityTxt.Text + "', CustomerName='" + SalesCustNameTxt.Text + "', CustomerContact='" + SalesCustConTxt.Text + "', Price='" + SalesPriceTxt.Text + "', Productname='" + SalesProductNameTxt.Text + "' where SalesId=" & salesId & ""
            cmd.ExecuteNonQuery()
